...
\begin{forthel}
  ...
  \begin{definition*}[for=Sum]
    Let $\kappa$ be a sequence of cardinals on $D$.
    \[ \Sum{\kappa}{D} \DefEq \Card{ \SumSet{\kappa}{D} }. \]
  \end{definition*}
  ...
  \begin{definition*}[for=Prod]
    Let $\kappa$ be a sequence of cardinals on $D$.
    \[ \Prod{\kappa}{D} \DefEq \Card{ \ProdSet{\kappa}{D} }. \]
  \end{definition*}
\end{forthel}
...
\begin{forthel}
  ...
  \begin{proof}[method=contradiction]
    ...
    Take $\Lambda \Eq \UnionOver \Range(\lambda)$.
    ...
    \begin{proof}
      ...
      Thus $\Im{F}{\kappa_{i}} \Eq \Delta(i)$.
      Therefore $\Card{\Delta(i)}
        \Eq \Card{\Im{F}{\kappa_{i}}}
        \Leq \Card{\kappa_{i}}
        \Eq \kappa_{i}
        \Less \lambda_{i}$.
      Indeed $\Card{\Im{F}{\kappa_{i}}} \Leq \Card{\kappa_{i}}$ (by \sn{cardinality of image}).
      Indeed $\kappa_{i}$ and $\lambda_{i}$ are sets.
    \end{proof}

    Define $f(i) \DefEq$ ``choose an element $v$ of $\lambda_{i} \Diff \Delta(i)$ in $v$'' for $i \Elem D$.
    Indeed $\lambda_{i} \Diff \Delta(i)$ is nonempty for each $i \Elem D$.
    Then $f$ is an element of $\ProdSet{\lambda}{D}$.
