...
term_name (TermBinaryAdjective t) = "are" <> Bytes.concat (map patternToBytes t)
term_name (TermUnaryVerb t) = "does" <> Bytes.concat (map patternToBytes t)
term_name (TermBinaryVerb t) = "do" <> Bytes.concat (map patternToBytes t)
